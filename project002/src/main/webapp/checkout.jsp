                                            ...
                                            <div class="form-group paypal">
                                                ...
                                                <form class="ps-checkout__form" action="./addtoorder" method="get">  
                                                    <div class="form-group form-group--inline">
                                                        ...
                                                        <input name="name" class="form-control" type="text" value="${info1.name}">
                                                    </div>

                                                    <div class="form-group form-group--inline">
                                                        <label>Email Address<span>*</span>
                                                        </label>
                                                        <input name="email" class="form-control" type="email" value="${info1.email}">
                                                    </div>
                                                    <div class="form-group form-group--inline">
                                                        <label>Phone<span>*</span>
                                                        </label>
                                                        <input name="phone" class="form-control" type="text" value="${info1.phone}">
                                                    </div>
                                                    <div class="form-group form-group--inline">
                                                        <label>Address<span>*</span>
                                                        </label>
                                                        <input name="address" class="form-control" type="text" value="${info1.address}">
                                                    </div>
                                                    <input name="paymentmethod" class="form-control" type="hidden" value="cash">
                                                    <p class="text-danger">${param.errorMessCheckout}</p>
