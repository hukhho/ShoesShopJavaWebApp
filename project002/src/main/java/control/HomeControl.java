...
public class HomeControl extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> list = dao.getProductHome(0);
        List<Brand> listbr = dao.getAllBrand();
        
        List<ProductFullInfo> listfull = dao.getAllProductFullInfo();

        String top1 = dao.getBestSellProduct();   
        
        List<ProductFullInfo> top1item = dao.getProductFullInfoByPid(top1);
           
        request.setAttribute("listP", list);
        request.setAttribute("listbr", listbr);
        request.setAttribute("top1item", top1item);
        ...
        {     
            ...
            User info1 = dao.getUserInfo(us.getUserid());
